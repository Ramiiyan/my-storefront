import Vue from 'vue';
import CompositionApi, { ref, customRef, shallowRef, onServerPrefetch, isRef, getCurrentInstance, toRefs, watch, reactive, computed, onBeforeMount } from '@vue/composition-api';
export { computed, createApp, customRef, getCurrentInstance, h, inject, isReactive, isReadonly, isRef, markRaw, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onServerPrefetch, onUnmounted, onUpdated, provide, proxyRefs, reactive, ref, set, shallowReactive, shallowReadonly, shallowRef, toRaw, toRef, toRefs, triggerRef, unref, useCSSModule, version, watch, watchEffect } from '@vue/composition-api';
...
const shallowSsrRef = (value, key) => {
    validateKey(key);
    if (process.client)
        return shallowRef(ssrValue(value, key));
