...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("26e33832", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_UserBillingAddresses_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(371);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_UserBillingAddresses_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_UserBillingAddresses_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_UserBillingAddresses_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_UserBillingAddresses_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".billing__addresses{display:grid;grid-template-columns:1fr 1fr}.billing-address-setAsDefault,.billing__addresses,.form__action-button--margin-bottom{margin-bottom:var(--spacer-xl)}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/Checkout/UserBillingAddresses.vue?vue&type=template&id=47eb5de3&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('SfAddressPicker',{staticClass:"billing__addresses",attrs:{"selected":String(_vm.currentAddressId)},on:{"input":function($event){return _vm.setCurrentAddress($event)}}},_vm._l((_vm.billingAddresses),function(billingAddress){return _c('SfAddress',{key:_vm.userBillingGetters.getId(billingAddress),attrs:{"name":String(_vm.userBillingGetters.getId(billingAddress))}},[_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getFirstName(billingAddress))+" "+_vm._s(_vm.userBillingGetters.getLastName(billingAddress)))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getStreetName(billingAddress))+"\n        "+_vm._s(_vm.userBillingGetters.getApartmentNumber(billingAddress)))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getPostCode(billingAddress)))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getCity(billingAddress))+_vm._s(_vm.userBillingGetters.getProvince(billingAddress) ? (", " + (_vm.userBillingGetters.getProvince(billingAddress))) : ''))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getCountry(billingAddress)))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(_vm.userBillingGetters.getPhone(billingAddress)))])])}),1),_vm._ssrNode(" "),_c('SfCheckbox',{staticClass:"billing-address-setAsDefault",attrs:{"data-cy":"billing-details-checkbox_isDefault","selected":_vm.setAsDefault,"name":"setAsDefault","label":"Use this address as my default one."},on:{"change":function($event){return _vm.$emit('changeSetAsDefault', $event)}}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Checkout/UserBillingAddresses.vue?vue&type=template&id=47eb5de3&
...
var SfAddressPicker = __webpack_require__(440);

// EXTERNAL MODULE: ./node_modules/@vue-storefront/commercetools/lib/index.es.js
var index_es = __webpack_require__(8);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Checkout/UserBillingAddresses.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var UserBillingAddressesvue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./components/Checkout/UserBillingAddresses.vue?vue&type=script&lang=js&
 /* harmony default export */ var Checkout_UserBillingAddressesvue_type_script_lang_js_ = (UserBillingAddressesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/Checkout/UserBillingAddresses.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  Checkout_UserBillingAddressesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var UserBillingAddresses = __webpack_exports__["default"] = (component.exports);
